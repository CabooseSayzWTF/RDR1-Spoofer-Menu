...
{
	char NPIDInfo[255];
	stradd_s(NPIDInfo, "Count: ");
	straddi_s(NPIDInfo, npid_index);
	stradd_s(NPIDInfo, "/7");
	stradd_s(NPIDInfo, "\n");
	stradd_s(NPIDInfo, "NPID: ");
	stradd_s(NPIDInfo, npidtext);
	print(NPIDInfo, 8000);
}
...
void backspace3()
{
	if (npid_index > 0)
	{
		char* ptr = npidtext[npid_index - 1] = 0x00;
		npid_index -= 1;
		NPIDInfoPrint();
	}
}
...
{
	memset(npidtext, 0, sizeof(npidtext));
	npid_index = 0;
	NPIDInfoPrint();
}
...
{
	if (gamertag_index >= 17)
	{
		print("<blue>Exceeded max buffer size, only 16 characters!", 5000);
		gamertag_index -= 1;
	}
}
...
void check_npid_index()
{
	if (npid_index >= 8)
	{
		print("<blue>Exceeded max buffer size, only 7 characters!", 5000);
		npid_index -= 1;
	}
}
...
void spoof_gamertag()
{
	void* playername1 = GET_LOCAL_PLAYER_NAME(0) - 0;
	void* playername2 = GET_LOCAL_PLAYER_NAME(0) - 64;
	void* playername3 = GET_LOCAL_PLAYER_NAME(0) - 116;
	void* playername4 = GET_LOCAL_PLAYER_NAME(0) - 180;
	char byte1[4] = { gamertag[0], gamertag[1],  gamertag[2], gamertag[3] };//gamertag[0]
	char byte2[4] = { gamertag[4], gamertag[5],  gamertag[6], gamertag[7] };
	char byte3[4] = { gamertag[8], gamertag[9],  gamertag[10], gamertag[11] };
	char byte4[4] = { gamertag[12], gamertag[13],  gamertag[14],  gamertag[15] };
	*(int*)(playername1 + 0x00) = *(int*)(byte1);
	*(int*)(playername1 + 0x04) = *(int*)(byte2);
	*(int*)(playername1 + 0x08) = *(int*)(byte3);
	*(int*)(playername1 + 0x0C) = *(int*)(byte4);
	*(int*)(playername2 + 0x00) = *(int*)(byte1);
	*(int*)(playername2 + 0x04) = *(int*)(byte2);
	*(int*)(playername2 + 0x08) = *(int*)(byte3);
	*(int*)(playername2 + 0x0C) = *(int*)(byte4);
	*(int*)(playername3 + 0x00) = *(int*)(byte1);
	*(int*)(playername3 + 0x04) = *(int*)(byte2);
	*(int*)(playername3 + 0x08) = *(int*)(byte3);
	*(int*)(playername3 + 0x0C) = *(int*)(byte4);
	*(int*)(playername4 + 0x00) = *(int*)(byte1);
	*(int*)(playername4 + 0x04) = *(int*)(byte2);
	*(int*)(playername4 + 0x08) = *(int*)(byte3);
	*(int*)(playername4 + 0x0C) = *(int*)(byte4);
	print("<blue>Spoofed! Find a new session for the spoof to take affect.</blue>", 10000);
}
void spoof_NPID()
{
	void* mynpid1 = GET_LOCAL_PLAYER_NAME(0) - 96;
	void* mynpid2 = GET_LOCAL_PLAYER_NAME(0) - 160;
	char byte1[4] = { npidtext[0], npidtext[1],  npidtext[2], npidtext[3] };//gamertag[0]
	char byte2[4] = { npidtext[4], npidtext[5],  npidtext[6] };
	*(int*)(mynpid1 + 0x00) = *(int*)(byte1);
	*(int*)(mynpid1 + 0x04) = *(int*)(byte2);
	*(int*)(mynpid2 + 0x00) = *(int*)(byte1);
	*(int*)(mynpid2 + 0x04) = *(int*)(byte2);
	print("<blue>Spoofed but doesn't work right</blue>", 15000);
}
void spoof_to_player_gamertag()
{
	void* snuGamerClass1 = GET_SLOT_NAME(net_selected_player) - 0;
	void* snuGamerClass2 = GET_SLOT_NAME(net_selected_player) - 64;
	void* snuGamerClass3 = GET_SLOT_NAME(net_selected_player) - 116;
	void* snuGamerClass4 = GET_SLOT_NAME(net_selected_player) - 180;
	void* playername1 = GET_LOCAL_PLAYER_NAME(0) - 0;
	void* playername2 = GET_LOCAL_PLAYER_NAME(0) - 64;
	void* playername3 = GET_LOCAL_PLAYER_NAME(0) - 116;
	void* playername4 = GET_LOCAL_PLAYER_NAME(0) - 180;
	//steal name
	*(int*)(playername1 + 0x00) = *(int*)(snuGamerClass1 + 0x00);
	*(int*)(playername1 + 0x04) = *(int*)(snuGamerClass1 + 0x04);
	*(int*)(playername1 + 0x08) = *(int*)(snuGamerClass1 + 0x08);
	*(int*)(playername1 + 0x0C) = *(int*)(snuGamerClass1 + 0x0C);
	*(int*)(playername2 + 0x00) = *(int*)(snuGamerClass2 + 0x00);
	*(int*)(playername2 + 0x04) = *(int*)(snuGamerClass2 + 0x04);
	*(int*)(playername2 + 0x08) = *(int*)(snuGamerClass2 + 0x08);
	*(int*)(playername2 + 0x0C) = *(int*)(snuGamerClass2 + 0x0C);
	*(int*)(playername3 + 0x00) = *(int*)(snuGamerClass3 + 0x00);
	*(int*)(playername3 + 0x04) = *(int*)(snuGamerClass3 + 0x04);
	*(int*)(playername3 + 0x08) = *(int*)(snuGamerClass3 + 0x08);
	*(int*)(playername3 + 0x0C) = *(int*)(snuGamerClass3 + 0x0C);
	*(int*)(playername4 + 0x00) = *(int*)(snuGamerClass4 + 0x00);
	*(int*)(playername4 + 0x04) = *(int*)(snuGamerClass4 + 0x04);
	*(int*)(playername4 + 0x08) = *(int*)(snuGamerClass4 + 0x08);
	*(int*)(playername4 + 0x0C) = *(int*)(snuGamerClass4 + 0x0C);
	print("<blue>Spoofed! Find a new session for the spoof to take affect.</blue>", 10000);
}
void stealnpid()
{
	void* mynpid1 = GET_LOCAL_PLAYER_NAME(0) - 96;
	void* mynpid2 = GET_LOCAL_PLAYER_NAME(0) - 160;
	void* therenpid1 = GET_SLOT_NAME(net_selected_player) - 96;
	void* therenpid2 = GET_SLOT_NAME(net_selected_player) - 160;
	//steal npid
	*(int*)(mynpid1 + 0x00) = *(int*)(therenpid1 + 0x00);
	*(int*)(mynpid1 + 0x04) = *(int*)(therenpid1 + 0x04);
	*(int*)(mynpid2 + 0x00) = *(int*)(therenpid2 + 0x00);
	*(int*)(mynpid2 + 0x04) = *(int*)(therenpid2 + 0x04);
	print("<blue>Spoofed but doesn't work right</blue>", 15000);
}
...
void save_xuid()
{
	...
	savename16 = *(byte*)(playerPointer2 + 0x0F);
	savenpid1 = *(byte*)(mynpid1 + 0x00);
	savenpid2 = *(byte*)(mynpid1 + 0x01);
	savenpid3 = *(byte*)(mynpid1 + 0x02);
	savenpid4 = *(byte*)(mynpid1 + 0x03);
	savenpid5 = *(byte*)(mynpid1 + 0x04);
	savenpid6 = *(byte*)(mynpid1 + 0x05);
	savenpid7 = *(byte*)(mynpid1 + 0x06);
	print("Current Name & NPID Saved For Resets", 5000);
}
///name shit
void changename()
{
...
void resetname()
{
	...
	void* mynpid1 = GET_LOCAL_PLAYER_NAME(0) - 96;
	void* mynpid2 = GET_LOCAL_PLAYER_NAME(0) - 160;
	*(byte*)(playername1 + 0x00) = savename1;
	*(byte*)(playername1 + 0x01) = savename2;
	*(byte*)(playername1 + 0x02) = savename3;
	*(byte*)(playername1 + 0x03) = savename4;
	*(byte*)(playername1 + 0x04) = savename5;
	*(byte*)(playername1 + 0x05) = savename6;
	*(byte*)(playername1 + 0x06) = savename7;
	*(byte*)(playername1 + 0x07) = savename8;
	*(byte*)(playername1 + 0x08) = savename9;
	*(byte*)(playername1 + 0x09) = savename10;
	*(byte*)(playername1 + 0x0A) = savename11;
	*(byte*)(playername1 + 0x0B) = savename12;
	*(byte*)(playername1 + 0x0C) = savename13;
	*(byte*)(playername1 + 0x0D) = savename14;
	*(byte*)(playername1 + 0x0E) = savename15;
	*(byte*)(playername1 + 0x0F) = savename16;
	*(byte*)(playername2 + 0x00) = savename1;
	*(byte*)(playername2 + 0x01) = savename2;
	*(byte*)(playername2 + 0x02) = savename3;
	*(byte*)(playername2 + 0x03) = savename4;
	*(byte*)(playername2 + 0x04) = savename5;
	*(byte*)(playername2 + 0x05) = savename6;
	*(byte*)(playername2 + 0x06) = savename7;
	*(byte*)(playername2 + 0x07) = savename8;
	*(byte*)(playername2 + 0x08) = savename9;
	*(byte*)(playername2 + 0x09) = savename10;
	*(byte*)(playername2 + 0x0A) = savename11;
	*(byte*)(playername2 + 0x0B) = savename12;
	*(byte*)(playername2 + 0x0C) = savename13;
	*(byte*)(playername2 + 0x0D) = savename14;
	*(byte*)(playername2 + 0x0E) = savename15;
	*(byte*)(playername2 + 0x0F) = savename16;
	*(byte*)(playername3 + 0x00) = savename1;
	*(byte*)(playername3 + 0x01) = savename2;
	*(byte*)(playername3 + 0x02) = savename3;
	*(byte*)(playername3 + 0x03) = savename4;
	*(byte*)(playername3 + 0x04) = savename5;
	*(byte*)(playername3 + 0x05) = savename6;
	*(byte*)(playername3 + 0x06) = savename7;
	*(byte*)(playername3 + 0x07) = savename8;
	*(byte*)(playername3 + 0x08) = savename9;
	*(byte*)(playername3 + 0x09) = savename10;
	*(byte*)(playername3 + 0x0A) = savename11;
	*(byte*)(playername3 + 0x0B) = savename12;
	*(byte*)(playername3 + 0x0C) = savename13;
	*(byte*)(playername3 + 0x0D) = savename14;
	*(byte*)(playername3 + 0x0E) = savename15;
	*(byte*)(playername3 + 0x0F) = savename16;
	*(byte*)(playername4 + 0x00) = savename1;
	*(byte*)(playername4 + 0x01) = savename2;
	*(byte*)(playername4 + 0x02) = savename3;
	*(byte*)(playername4 + 0x03) = savename4;
	*(byte*)(playername4 + 0x04) = savename5;
	*(byte*)(playername4 + 0x05) = savename6;
	*(byte*)(playername4 + 0x06) = savename7;
	*(byte*)(playername4 + 0x07) = savename8;
	*(byte*)(playername4 + 0x08) = savename9;
	*(byte*)(playername4 + 0x09) = savename10;
	*(byte*)(playername4 + 0x0A) = savename11;
	*(byte*)(playername4 + 0x0B) = savename12;
	*(byte*)(playername4 + 0x0C) = savename13;
	*(byte*)(playername4 + 0x0D) = savename14;
	*(byte*)(playername4 + 0x0E) = savename15;
	*(byte*)(playername4 + 0x0F) = savename16;
	//npid reset
	*(byte*)(mynpid1 + 0x00) = savenpid1;
	*(byte*)(mynpid1 + 0x01) = savenpid2;
	*(byte*)(mynpid1 + 0x02) = savenpid3;
	*(byte*)(mynpid1 + 0x03) = savenpid4;
	*(byte*)(mynpid1 + 0x04) = savenpid5;
	*(byte*)(mynpid1 + 0x05) = savenpid6;
	*(byte*)(mynpid1 + 0x06) = savenpid7;
	*(byte*)(mynpid2 + 0x00) = savenpid1;
	*(byte*)(mynpid2 + 0x01) = savenpid2;
	*(byte*)(mynpid2 + 0x02) = savenpid3;
	*(byte*)(mynpid2 + 0x03) = savenpid4;
	*(byte*)(mynpid2 + 0x04) = savenpid5;
	*(byte*)(mynpid2 + 0x05) = savenpid6;
	*(byte*)(mynpid2 + 0x06) = savenpid7;
	print("<green>Name & NPID Reset - Find New Session So It Updates For Everyone", 5000);
}
void New_session()
{
